...
declare namespace CodeceptJS {
  interface SupportObject { I: I, current: any, indexPage: indexPage, registerPage: registerPage, successPage: successPage, productPage: productPage, checkoutPage: checkoutPage, cartPage: cartPage }
